...
class LocationSelectHandler(StateHandler):
    ...
    def setBaseLayerStr(self, value: str) -> Optional[str]:
        return self.context.updateValue(
            LocationSelectHandler.KBaseLayer, value)
...
class CenterPointsHandler(StateHandler):
    ...
    def canTransitionTo(self, targetState: 'DialogState') -> bool:
        return targetState in [
            DialogState.WELCOME, DialogState.LOCATIONSELECT, DialogState.CENTERPOINTSEDIT]
    ...
    def removeCenterLayer(self) -> Optional[CenterLayer]:
        DialogState.deleteValuesAfterContext(
            DialogState.CENTERPOINTS, "LayerKeys")
    ...
    def setCenterLayer(self, value: CenterLayer) -> Optional[CenterLayer]:
        DialogState.deleteValuesAfterContext(
            DialogState.CENTERPOINTS, "LayerKeys")
        return self.context.updateValue(
            CenterPointsHandler.KCenterLayer, value)

    def getGenerateMethod(self) -> DirectRouteGenerateMethod:
        return self.context.getOrSetDefault(
            CenterPointsHandler.KGenerateMethod, default=DirectRouteGenerateMethod.default())

    def setGenerateMethod(
            self, value: DirectRouteGenerateMethod) -> Optional[DirectRouteGenerateMethod]:
        return self.context.updateValue(
            CenterPointsHandler.KGenerateMethod, value, default=DirectRouteGenerateMethod.default())

    def getLOCS(self) -> List[LevelOfCentrality]:
        return self.context.getOrSetDefault(
            CenterPointsHandler.KLOCs, default=LevelOfCentrality.defaults())

    def setLOCs(self, value: List[LevelOfCentrality]
                ) -> Optional[List[LevelOfCentrality]]:
        return self.context.updateValue(
            CenterPointsHandler.KLOCs, value, default=LevelOfCentrality.defaults())
...
class CenterPointsEditHandler(StateHandler):
    ...
    def canTransitionTo(self, targetState: 'DialogState') -> bool:
        return targetState in [DialogState.WELCOME, DialogState.LOCATIONSELECT,
                               DialogState.CENTERPOINTS, DialogState.AIRLINE]
...
class AirlineHandler(StateHandler):
    ...
    def canTransitionTo(self, targetState: 'DialogState') -> bool:
        return targetState in [DialogState.WELCOME, DialogState.LOCATIONSELECT,
                               DialogState.CENTERPOINTSEDIT, DialogState.REPROJECT, DialogState.REPROJECTDEMAND]

    def getDirectRouteLayer(self) -> Optional[DirectRouteNetworklayer]:
        return self.context.get(AirlineHandler.KDirectRouteLayer)

    def setDirectRouteLayer(
            self, value: DirectRouteNetworklayer) -> DirectRouteNetworklayer:
        DialogState.deleteValuesAfterContext(DialogState.AIRLINE, "LayerKeys")
        return self.context.updateValue(
            AirlineHandler.KDirectRouteLayer, value)
...
class ReprojectHandler(StateHandler):
    ...
    def onEnter(self, previousState: Optional['DialogState'] = None):
        ...
        self.context.updateValue(
            ReprojectHandler.KDetourTolerance, REPROJECT_DETOUR_FACTOR)
        self.handleUi()
    ...
    def canTransitionTo(self, targetState: 'DialogState') -> bool:
        return targetState in [DialogState.WELCOME, DialogState.LOCATIONSELECT,
                               DialogState.AIRLINE, DialogState.REPROJECTDEMAND]
    ...
    def getProgress(self) -> RouteNetworkTaskProgress:
        return self.context.get(
            ReprojectHandler.KProgress, RouteNetworkTaskProgress(0))

    def setProgress(
            self, value: RouteNetworkTaskProgress) -> RouteNetworkTaskProgress:
        return self.context.updateValue(
            ReprojectHandler.KProgress, value, default=RouteNetworkTaskProgress(0))
    ...
    def setDetourTolerance(self, value: float) -> float:
        return self.context.updateValue(
            ReprojectHandler.KDetourTolerance, value)
    ...
    def setNetworklayer(self, value: QgsVectorLayer) -> QgsVectorLayer:
        DialogState.deleteValuesAfterContext(
            DialogState.REPROJECT, "LayerKeys")
    ...
    def setPathfinder(
            self, value: NetworkPathFinder) -> Optional[NetworkPathFinder]:
    ...
    def setRouteLayer(
            self, value: RouteNetworklayer) -> Optional[RouteNetworklayer]:
        DialogState.deleteValuesAfterContext(
            DialogState.REPROJECT, "LayerKeys")
    ...
    def setSupplyNetworkLayer(
            self, value: SupplyNetworkElementLayer) -> Optional[SupplyNetworkElementLayer]:
        DialogState.deleteValuesAfterContext(
            DialogState.REPROJECT, "LayerKeys")
        return self.context.updateValue(
            ReprojectHandler.KSupplyNetworkLayer, value)

    def hasSupplyNetworkLayer(self) -> bool:
        return self.context.has(ReprojectHandler.KSupplyNetworkLayer)

    def setAggregatedSupplyNetworkLayer(
            self, value: SupplyAggregatedNetworkElementLayer) -> Optional[SupplyAggregatedNetworkElementLayer]:
        DialogState.deleteValuesAfterContext(
            DialogState.REPROJECT, "LayerKeys")
        return self.context.updateValue(
            ReprojectHandler.KAggregatedSupplyNetworkLayer, value)

    def setBreakingPointsNetworkLayer(
            self, value: BreakingPointsNetworkLayer) -> Optional[BreakingPointsNetworkLayer]:
        DialogState.deleteValuesAfterContext(
            DialogState.REPROJECT, "LayerKeys")
        return self.context.updateValue(
            ReprojectHandler.KBreakingPointsNetworkLayer, value)

    def setMissingRoutesLayer(
            self, value: MissingRoutesLayer) -> Optional[MissingRoutesLayer]:
        DialogState.deleteValuesAfterContext(
            DialogState.REPROJECT, "LayerKeys")
        return self.context.updateValue(
            ReprojectHandler.KMissingRoutesLayer, value)

    def setCenterDistanceTolerance(self, value: int) -> Optional[int]:
        return self.context.updateValue(
            ReprojectHandler.KCenterDistanceTolerance, value)

    def setReduceNetworkbounds(self, value: bool) -> Optional[bool]:
        return self.context.updateValue(
            ReprojectHandler.KReduceNetworkBounds, value)

    def setFitlerAttributeMode(self, value: str) -> Optional[str]:
        return self.context.updateValue(
            ReprojectHandler.KFilterAttributeMode, value)
...
class ReprojectDemandHandler(StateHandler):
    ...
    def onEnter(self, previousState: Optional['DialogState'] = None):
        ...
        # (Moved from user definable to an implementation detail)
        self.context.updateValue(
            ReprojectDemandHandler.KDetourTolerance, REPROJECT_DETOUR_FACTOR)
        self.handleUi()
    ...
    def canTransitionTo(self, targetState: 'DialogState') -> bool:
        return targetState in [DialogState.WELCOME,
                               DialogState.LOCATIONSELECT, DialogState.REPROJECT]
    ...
    def getProgress(self) -> RouteNetworkTaskProgress:
        return self.context.get(
            ReprojectDemandHandler.KProgress, RouteNetworkTaskProgress(0))

    def setProgress(
            self, value: RouteNetworkTaskProgress) -> RouteNetworkTaskProgress:
        return self.context.updateValue(
            ReprojectDemandHandler.KProgress, value, default=RouteNetworkTaskProgress(0))
    ...
    def setDetourTolerance(self, value: float) -> float:
        return self.context.updateValue(
            ReprojectDemandHandler.KDetourTolerance, value)
    ...
    def setDemandFieldName(self, value: str) -> str:
        return self.context.updateValue(
            ReprojectDemandHandler.KDemandFieldName, value)
    ...
    def setNetworklayer(self, value: QgsVectorLayer) -> QgsVectorLayer:
        DialogState.deleteValuesAfterContext(
            DialogState.REPROJECTDEMAND, "LayerKeys")
        return self.context.updateValue(
            ReprojectDemandHandler.KNetworkLayer, value)
    ...
    def setPathfinder(
            self, value: NetworkPathFinder) -> Optional[NetworkPathFinder]:
        return self.context.updateValue(
            ReprojectDemandHandler.KPathfinder, value)
    ...
    def setRouteLayer(
        ...
        DialogState.deleteValuesAfterContext(
            DialogState.REPROJECTDEMAND, "LayerKeys")
        return self.context.updateValue(
            ReprojectDemandHandler.KRouteLayer, value)
    ...
    def setSupplyNetworkLayer(
        ...
        DialogState.deleteValuesAfterContext(
            DialogState.REPROJECTDEMAND, "LayerKeys")
        return self.context.updateValue(
            ReprojectDemandHandler.KSupplyNetworkLayer, value)
    ...
    def setAggregatedSupplyNetworkLayer(
        ...
        DialogState.deleteValuesAfterContext(
            DialogState.REPROJECTDEMAND, "LayerKeys")
        return self.context.updateValue(
            ReprojectDemandHandler.KAggregatedSupplyNetworkLayer, value)
    ...
    def setBreakingPointsNetworkLayer(
        ...
        DialogState.deleteValuesAfterContext(
            DialogState.REPROJECTDEMAND, "LayerKeys")
        return self.context.updateValue(
            ReprojectDemandHandler.KBreakingPointsNetworkLayer, value)
    ...
    def setMissingRoutesLayer(
        ...
        DialogState.deleteValuesAfterContext(
            DialogState.REPROJECTDEMAND, "LayerKeys")
        return self.context.updateValue(
            ReprojectDemandHandler.KMissingRoutesLayer, value)

    def setCenterDistanceTolerance(self, value: int) -> Optional[int]:
        return self.context.updateValue(
            ReprojectDemandHandler.KCenterDistanceTolerance, value)

    def setReduceNetworkbounds(self, value: bool) -> Optional[bool]:
        return self.context.updateValue(
            ReprojectDemandHandler.KReduceNetworkBounds, value)

    def setFitlerAttributeMode(
            self, value: NetworkSource) -> Optional[NetworkSource]:
        return self.context.updateValue(
            ReprojectDemandHandler.KFilterAttributeMode, value)
...
class DialogState(Enum):
    ...
    @staticmethod
    def deleteValuesAfterContext(
            currentState: 'DialogState', keyAttributesName: str):
        kvs = DialogState.getValuesAfterContext(
            currentState, keyAttributesName)

        context = DialogState.context()
        for key in kvs.keys():
            context.delete(key)

    def getValuesAfterContext(
            currentState: 'DialogState', keyAttributesName: str) -> Dict[str, Any]:
        kvs = dict()
        ...
        for resetState in states[nextState:]:
            if hasattr(resetState.value, keyAttributesName):
                resetAttributeValues = getattr(
                    resetState.value, keyAttributesName)
...
class DialogStateContext:
    ...
    def updateValue(self, key: str, value: Any,
...
class DialogStateMachine:
    ...
    def transitionTo(self, targetState: DialogState,
    ...
    def addTransitionCallback(
            self, fromState: DialogState, toState: DialogState, callback: Callable):
