...
class ARSIndex:
            ...
            with open(filePath, 'r', encoding='utf-8') as file:
                ...
                for row in csvReader:
                    ...
                    try:
                        ...
                        center = QgsPointXY(
                            float(row[xIndex]), float(row[yIndex]))
    ...
    def findNamesBySearchName(self, searchName: str,
                              maxResults: int = 10) -> List[str]:
    ...
    def searchByName(self, searchName: str, threshold: float = 0.7,
                     maxResults: int = 10) -> List[Tuple[ARSCode, int]]:
        """
