...
class RouteNetworkTaskResult:
    def __init__(self, routeEntries: Optional[List[RouteEntry]] = None, networkElements: Optional[List[NetworkElement]] = None,
                 aggregatedElements: Optional[List[AggregatedNetworkElement]] = None, breakingPoints: Optional[List[BreakingElement]] = None, error: str = None):
    ...
    def createSuccess(
        ...
        return RouteNetworkTaskResult(routeEntries=routeEntries, networkElements=networkElements,
                                      aggregatedElements=aggregatedElements, breakingPoints=breakingPoints)
